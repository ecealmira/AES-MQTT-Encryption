...
class ComputerA():
    ...
    def __init__(
        ...
        """
        Initialize the ComputerA object.
    ...
    def run(self) -> None:
        """
        Start the MQTT client and send the public key to Computer B.

        This function connects the client to the MQTT broker, starts the client loop, sends
        the public key to Computer B, and then listens for responses until the process is completed.
        ...
        try:
            # Generate and send the public key (A) to Computer B
            ...
            print("Communication complete. Stopping Computer A.")
...
computer_a = ComputerA(broker, port, topic, topic_encryption, aes_key, "mark14", False, True)
computer_a.run()